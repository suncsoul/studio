...
export function HireCompanionCard({
  ...
  return (
    <Card className="transition-all hover:shadow-lg hover:border-holographic-purple/50">
      <CardContent className="p-4 flex flex-col items-center justify-between gap-4 text-center">
        <Link href={`/view-profile/${encodeURIComponent(providerName)}`} className="flex flex-col items-center gap-4 w-full">
          <Avatar className="h-20 w-20 border-2 border-holographic-purple/50">
        ...
        <div className="flex flex-col items-center gap-2 w-full mt-2">
            ...
            <Button variant="default" className="w-full sm:w-auto bg-holographic-purple hover:bg-holographic-purple/90 text-white mt-2">
